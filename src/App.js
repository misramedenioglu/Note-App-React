...
function App() {
  ...
  return (
    <div className='container'>
      ...
      <div className="notes">
        {filteredNotes.length > 0 && <h2>Notes:</h2>}
        ...
        {filteredNotes.length > 0 && (
          <h3>
            {filteredNotes.length > 0 && `Not 1: ${filteredNotes[0].text}`}<br />
            {filteredNotes.length > 1 && `Not 2: ${filteredNotes[1].text}`}<br />
            {filteredNotes.length > 2 && `Not 3: ${filteredNotes[2].text}`}
          </h3>
        )}
      </div>
    </div>
